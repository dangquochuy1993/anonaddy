                ...
                <form method="POST" action="{{ route('login.backup_code.login') }}">
                    ...
                    <div class="px-6 py-8 md:p-10">
                        ...
                        <h1 class="text-center font-bold text-3xl">
                            Đăng nhập bằng mã dự phòng 2FA
                        </h1>
                        ...
                        <div class="text-sm border-t-8 rounded text-yellow-800 border-yellow-600 bg-yellow-100 px-3 py-4 mt-4" role="alert">
                            Sau khi đăng nhập bằng mã dự phòng, xác thực hai yếu tố sẽ bị tắt trên tài khoản của bạn. Nếu vẫn muốn sử dụng 2FA, hãy bật lại sau khi đăng nhập.
                        </div>
